-- Repair/verify the append-only archive constraints for installations that
-- recorded an earlier archive migration before its DDL completed.  This is
-- intentionally idempotent and contains no source CSV data.
